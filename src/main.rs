...
async fn main() {
    ...
    loop {
        ...
        for effect in splash_effects.iter_mut() {
            effect.timer -= dt;
        }
        splash_effects.retain(|e| e.timer > 0.0);
        ...
        // Draw splash effects (world-space)
        ...
        // === World-space Build overlays (drawn in camera space) ===
